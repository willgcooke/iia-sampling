...
from optimizers.iia_optimizer_two_coeff import IIAOptimizerTwoCoeff, load_prompts
import time
import os
...
def main():
    ...
    OUTPUT_PATH = COEFFICIENTS_DIR / f"iia_coefficients_two_coeff_{NUM_INFERENCE_STEPS}.pt"
    CHECKPOINT_PATH = COEFFICIENTS_DIR / f"iia_checkpoint_two_coeff_{NUM_INFERENCE_STEPS}.pt"
    
    print("="*60)
    print("Two-Coefficient IIA Optimization (Equation 6)")
    print("="*60)
    ...
    optimizer = IIAOptimizerTwoCoeff(
        model=unet,
        scheduler=scheduler,
